...
\subsubsubsection{Executive Slate Application.}
...
\subsubsubsection{Not Attending a Mandatory Candidates' Meeting.}
Candiates \todo{typo} wishing to be placed on the ballot and having submitted a complete candidacy application on time that fail to attend a mandatory candidates' meeting shall be in violation of this rule. Candidates may not be found to be in violation of this rule more than once per election cycle.
...
\subsubsubsection{Influencing a Student While Voting Prohibited.}
...
\subsubsubsection{Inappropriate and irresponsible use of email privileges is prohibited.}
